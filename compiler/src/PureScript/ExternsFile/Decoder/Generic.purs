...
-- | Decode an ADT from its CBOR (cborg/Serialise) encoding: a constructor is a
-- | CBOR array `[ctorTag, arg0, arg1, ...]`, where `ctorTag` is the 0-based
-- | constructor index within the type's `Sum` tree.
