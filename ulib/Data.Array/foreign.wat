;; ulib: curated wasm FFI for `Data.Array` (ADR 0012). A *fragment* — `bin` wraps it as
;; `(module <ulib/_header.wat> <this>)`, so the GC value types come from the shared header
;; and `wasm-merge` canonicalises them; the runtime-core helpers are imported from "rt".
