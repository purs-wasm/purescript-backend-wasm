-- | ulib SHADOW of `prelude`'s `Data.Functor` (ADR 0028), targeting prelude 6.0.2.
-- |
...
-- ulib shadow: `arrayMap` over WasmBase primitives, so the mapped closure specializes on wasm
